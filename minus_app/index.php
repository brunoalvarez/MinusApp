...
<form  method="post">
	...
	Latitude: <input type="text" name="Latitude" value="-23.5637676"/>
	Longitude: <input type="text" name="Longitude" value="-46.6744988"/>
...
<tr>
	...
	<?php	
		...
		FROM REGISTER reg 
		INNER JOIN User user on reg.UserId = user.Id order by 1 desc";
